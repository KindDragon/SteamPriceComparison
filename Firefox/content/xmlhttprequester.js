function steampricecomparison_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
steampricecomparison_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				steampricecomparison_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
steampricecomparison_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
steampricecomparison_xmlhttpRequester.prototype.setupRequestEvent =
