...
//If set to true, CIS (UA and KZ) prices will be displayed
var showCISPrice = true;
...
function stateChanged() {
    ...
    for (i=0; i<pricenodes.length; i++) {	
        ...
        for (var j = 0; j < pages.length; j++)
            if (pages[j].show && pages[j].price != null) {
